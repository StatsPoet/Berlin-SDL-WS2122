...
```{r}
save(image_an_mvars_df_ind_pic_only ,file="5_fulldata_dum.Rda")
```
...
save(image_an_mvars_df ,file="4_fulldata.Rda")
```
...
save(image_an_mvars_df_sums_only ,file="6_fulldata_abs.Rda") # Full data with absolute frequencies.
```
