...
```{r}
load("~/R/WS_21_22/DeepL/Berlin-SDL-WS2122/data/image_an_mvars_df.Rda")
```
...
```{r}
test <- data.matrix(image_an_mvars_df)
```
...
```{r}
train_targets <- data.matrix(train_targets)
test_targets <- data.matrix(test_targets)
