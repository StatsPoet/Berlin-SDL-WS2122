...
#Next step: WordClouds Transperent
  # https://github.com/timdream/wordcloud2.js/issues/90
    # der buck scheint noch nicht behoben wurden zu sein. Bisher habe ich keinen               Workaround gefunden.
```
