...
```{r}
['Alarm_clock', 'Bathroom_cabinet', 'Bathtub', 'Bed', 'Bookcase', 'Ceiling_fan', 'Chest_of_drawers', 'Clock', 'Closet', 'Computer_monitor', 'Couch', 'Curtain', 'Dining_table', 'Dishwasher', 'Drawer', 'Fireplace', 'Gas_stove', 'Home_appliance', 'Infant_bed', 'Microwave_oven', 'Sofa_bed', 'Toilet', 'Wardrobe', 'Washing_machine']
```
