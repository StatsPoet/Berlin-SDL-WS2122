...
smp_size <- floor(0.85 * nrow(image_an_mvars_df))
...
## Model in progress
Added additional layers and units to account for the higher number of variables. 
For a large input layer the leaky relu is suggested. 

- i use sigmoid only in the last one eventhough caret suggests it in general. But if i use leaky_relu i can present it. Since it could help with a large dataframe, it makes sense here
```{r defModel}
